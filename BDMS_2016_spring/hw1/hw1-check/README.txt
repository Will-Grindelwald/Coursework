...
4. run test 
   ...
   run.out contains all the outputs from run-test.pl.
   You can have a look to see the actual test commands.

   (Note: To avoid any precision problem from floating point computation, 
       the groupby test uses only count and max.)
